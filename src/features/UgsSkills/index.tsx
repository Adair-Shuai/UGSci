        ...
        {group.items.map((skill) => (
          ...
          >
            <div style={{ alignItems: 'center', display: 'flex', gap: 6, marginBottom: 4 }}>
              <span style={{ color: '#1f1f1f', fontSize: 13, fontWeight: 500 }}>{skill.name}</span>
    ...
    <div style={{ padding: '24px 32px', maxWidth: 1200, margin: '0 auto' }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ color: '#888', fontSize: 13, marginTop: 4 }}>
          技能是对能力（Capability）的业务封装——用户说"帮我画相图"，技能路由到 NeqSim 的相图生成能力
        </p>
      </div>
      ...
      <div style={{ display: 'flex', gap: 16, marginBottom: 20 }}>
        <Card size="small" style={{ flex: 1 }}>
          ...
          <div style={{ color: '#185FA5', fontSize: 20, fontWeight: 600 }}>
            {UGS_SKILLS.reduce((sum, g) => sum + g.items.length, 0)}
          </div>
        </Card>
        <Card size="small" style={{ flex: 1 }}>
