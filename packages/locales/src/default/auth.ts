export default {
  ...
  'betterAuth.signin.signingIn': 'Signing in...',
  ...
  // UGS-MODIFY: email OTP sign-in flow
  'ugs.emailCode.back': 'Back to email login',
  'ugs.emailCode.codeLength': 'Verification code must be 6 digits',
  'ugs.emailCode.codePlaceholder': '6-digit code',
  'ugs.emailCode.codeRequired': 'Please enter the verification code',
  'ugs.emailCode.countdown': 'Resend in {{seconds}}s',
  'ugs.emailCode.desc': 'Verification code sent to {{email}}',
  'ugs.emailCode.newUserHint':
    'This email is not registered. Using verification code login will auto-register.',
  'ugs.emailCode.noPasswordHint':
    'This email has no password set. Please use verification code to log in and set a password.',
  'ugs.emailCode.resend': "Didn't receive the code?",
  'ugs.emailCode.resendBtn': 'Resend',
  'ugs.emailCode.sendError': 'Failed to send verification code',
  'ugs.emailCode.sent': 'Verification code sent, please check your email',
  'ugs.emailCode.title': 'Email Verification Code Login',
  'ugs.emailCode.verify': 'Verify & Sign In',
  'ugs.emailCode.verifyError': 'Verification failed',
  'ugs.signin.checkUser': 'Next',
  'ugs.signin.codeLoginRegister': 'Code Login / Register',
  'ugs.signin.passwordLogin': 'Password Login',
  'ugs.setPassword.title': 'Set Password',
  'ugs.setPassword.desc': 'Set a password for future password-based login',
  'ugs.setPassword.confirmPlaceholder': 'Re-enter password',
  'ugs.setPassword.confirmPasswordPlaceholder': 'Confirm your password',
  'ugs.setPassword.confirmRequired': 'Please confirm your password',
  'ugs.setPassword.error': 'Failed to set password',
  'ugs.setPassword.mismatch': 'The passwords do not match',
  'ugs.setPassword.passwordMinLength': 'Password must be at least 8 characters',
  'ugs.setPassword.passwordMismatch': 'The passwords do not match',
  'ugs.setPassword.passwordPlaceholder': 'Enter your password (min. 8 characters)',
  'ugs.setPassword.passwordRequired': 'Please enter a password',
  'ugs.setPassword.skip': 'Skip, set later',
  'ugs.setPassword.submit': 'Set Password & Continue',
  'ugs.setPassword.success': 'Password set successfully!',
  'ugs.phoneSignin.sendError': 'Failed to send verification code',
  'ugs.phoneSignin.sent': 'Verification code sent, please check server console in dev mode',
  'ugs.phoneSignin.verifyError': 'Verification failed',
};
