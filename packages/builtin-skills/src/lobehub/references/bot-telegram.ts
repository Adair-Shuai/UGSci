...
- **Secret Token** (optional): a custom string you define; UGSci includes it in webhook requests so you can verify they genuinely come from UGSci — leave blank unless you have a security requirement
